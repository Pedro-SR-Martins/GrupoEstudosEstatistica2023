...
Caso as coisas fiquem esquisitas aqui, você deve acrescentar a interação da sua VI com o log dela, algo como:  
...
plot(residuals.glm(fitlog, "deviance"))
```
...
Até 5 pode ser considerado aceitável. Mas os valores poderiam ser melhores...  
